...
# Rota para baixar os dados do histórico em Excel (CSV)
...
# Rota do Painel da Máquina de Solda (17 Canais + Botão Excel no Topo)
...
def painel_visual():
    ...
    <head>
        ...
        <style>
            ...
            .btn-voltar { background-color: #46485f; color: white; padding: 8px 16px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: bold; }
            .btn-voltar:hover { background-color: #5c5f78; }
            .btn-excel { background-color: #217346; color: white; padding: 8px 16px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: bold; display: flex; align-items: center; gap: 6px; }
    ...
    <body>
        <div class="header-bar">
            ...
            <div class="acoes-topo">
                <a href="/baixar-excel" class="btn-excel">📊 Baixar Histórico (Excel)</a>
